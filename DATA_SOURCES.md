...
- After quality filtering (monotonicity checks, minimum 5 measured SWCC points, complete feature set): **556 samples** retained
- Preprocessing pipeline: `scripts/data_preprocessing/extract_unsoda_data.py` → `phase1_preprocessing.py`
- Train/val/test split: **389 / 83 / 84 samples** (70 / 15 / 15 %, stratified by soil texture class)
...
- Suction grid (suction_grid.npy) — matric potential in kPa, log-spaced from 0.1 to 10⁶ kPa (100 points)
